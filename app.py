...
def varrer_mercado_ao_vivo():
    tickers = [
        ...
        "AURE3", "AVGO34", "AXIA3", "AXIA6", "AXIA7", "AXPB34", "AZEV3", "AZEV4", "AZUL4", "AZZA3",
        ...
        "BMOB3", "BOAC34", "BOBR4", "BOVA11", "BPAC11", "BRAP3", "BRAP4", "BRAV3", "BRBI11", "BRFS3",
        ...
        "MOVI3", "MRCK34", "MRFG3", "MRVE3", "MSBR34", "MSCD34", "MSFT34", "MTRE3", "MULT3", "MUTC34",
